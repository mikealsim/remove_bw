# About
This python aplication and library will remove all white or black from an image, prefectly preserving the color and value of the rest of the image. It's based on a previous phtoshop plugin I created, call killwhite.
