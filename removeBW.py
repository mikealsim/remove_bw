...
if __name__ == "__main__":
    ...
    parser.add_argument("-a", "--alpha_suffix",
                    help="[Optional] Alpha Suffix, only if you want a seperate alpha,\n"
    ...
    parser.add_argument("-b", '--remove_black', 
                        help="Remove black from an image",
    ...
    if args.remove_black:
        img, alpha = removeBWLib.RemoveBlack(img)
    else:
        img, alpha = removeBWLib.RemoveWhite(img)
